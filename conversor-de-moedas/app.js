...
const init = async () => {
  ...
  convertedValueEl.innerHTML = internalExchangeRate.conversion_rates.BRL.toFixed(2);
  valuePrecisionEl.innerHTML = `1 USD = ${internalExchangeRate.conversion_rates.BRL} BRL`;
}
